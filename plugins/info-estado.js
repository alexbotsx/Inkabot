...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} 𝐈𝐍𝐊𝐀𝐈𝐊𝐎𝐒 𝐁𝐎𝐓
  ${tradutor.texto1[2]} +51968914403
  ${tradutor.texto1[3]} https://www.instagram.com/inkaikos_ff?igsh=cGdhdXJ0cXIxeXNp
  ...
  const Message = {
    document: { url: `ttps://www.instagram.com/inkaikos_ff` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "ttps://www.instagram.com/inkaikos_ff",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐈𝐍𝐊𝐀𝐈𝐊𝐎𝐒 𝐁𝐎𝐓",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "ttps://www.instagram.com/inkaikos_ff",
      },
    },
    caption: info,
    footer: wm,
